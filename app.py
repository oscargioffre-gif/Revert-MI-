...
if selected_full in data:
    ...
    * { box-sizing: border-box; }
    body { margin:0; padding:4px; background:#0d0f14; color:#c9d1d9; font-family:'IBM Plex Mono',monospace; }
    /* DESKTOP */
    .cal-wrap { overflow-x: auto; }
    .cal-table { border-collapse:collapse; width:100%; font-size:0.74rem; }
    .cal-table th { background:#0d0f14; color:#6e7f9a; font-size:0.6rem; letter-spacing:0.08em;
                    text-transform:uppercase; padding:5px 3px; text-align:center;
                    border-bottom:1px solid #1e2535; white-space:nowrap; }
    .cal-table td { padding:3px 2px; text-align:center; border-bottom:1px solid #1a1f2e; min-width:34px; }
    .cal-table tr:hover td { background:#141922; }
    .day-up { color:#3fb950; font-size:0.68rem; line-height:1.3; }
    .day-dn { color:#f85149; font-size:0.68rem; line-height:1.3; }
    .day-na { color:#2a3545; font-size:0.68rem; }
    .month-label { color:#79c0ff; font-weight:600; text-align:left !important;
                   padding-left:8px !important; white-space:nowrap; min-width:108px; }
    .stat-cell { color:#c9d1d9; font-size:0.68rem; white-space:nowrap; }
    .stat-pos { color:#3fb950; } .stat-neg { color:#f85149; }
    ...
    @media (max-width:640px) {
      ...
      .month-card { background:#111520; border:1px solid #1e2535; border-radius:10px;
                    margin-bottom:10px; overflow:hidden; }
      .mch { display:flex; justify-content:space-between; align-items:center;
             padding:10px 14px; border-bottom:1px solid #1e2535; background:#0d0f14; }
      .mch-title { color:#79c0ff; font-weight:600; font-size:0.88rem; }
      .mch-ret { font-size:0.88rem; font-weight:600; }
      .mcs { display:flex; gap:14px; padding:7px 14px; border-bottom:1px solid #1e2535;
             font-size:0.7rem; color:#6e7f9a; flex-wrap:wrap; }
      .dgrid { display:grid; grid-template-columns:repeat(7,1fr); gap:2px; padding:7px; }
      .dc { text-align:center; padding:5px 2px; border-radius:5px; font-size:0.62rem; line-height:1.4; }
      .dc.up { background:#1a3a23; color:#3fb950; }
      .dc.dn { background:#3a1a1a; color:#f85149; }
      .dc.na { color:#2e3a4e; }
      .dn-num { font-size:0.55rem; color:#4a5a6e; display:block; }
    }
    """
