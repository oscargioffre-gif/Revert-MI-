...
def load_all(tickers):
    ...
    for ticker in tickers:
        try:
            # Use explicit date range to always get latest session
...
_now = datetime.datetime.now().strftime("%d/%m/%Y %H:%M")
st.caption(f"🕐 Dati aggiornati al: **{_now}** · Cache 5 min · Premi 🔄 per forzare il refresh")
